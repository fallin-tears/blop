                      ...
                      <ol className="pl-3">
                        ...
                        <li className="text-white list-disc list-inside">
                          ...
                          <ul className="list-disc list-inside pl-5">
                            ...
                            <li>
                              <a
                                href="https://docs.Pretend.cc"
                                className="text-blue-400"
                                target="_blank"
                              >
                                https://docs.Pretend.cc
                                </a>
                            </li>
                            <li>
                              <a
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      ...
                      <br />
                      <br />
                      Pretend (Bot) also reserves the right to pull any services
                    ...
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      ...
                      <ol className="text-white list-disc list-inside pl-3">
                        <li>
                          ...
                          such as <b>Pretend (Bot) API</b>
                        </li>
                        <li>
                          <b>Attempt to hack:</b> you may not attempt to hack{" "}
                          <b>Pretend (Bot)</b> in any way
                        </li>
                        <li>
                          <b>Improper use:</b> you must use Pretend (Bot) in a way
                        ...
                        <li>
                          ...
                          have the purpose of attacking <b>Pretend (Bot)</b> and
                        ...
                        <li>
                          ...
                          of damaging our company, brand, and services (Pretend Bot). This includes but is not
