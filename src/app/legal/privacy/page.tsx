          ...
          <div className="h-full flex flex-col justify-between">
            ...
            <div>
              ...
              <div className="px-6 flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      <i>
                        ...
                        “Our”, or “Company” refer to the Pretend (Bot) or the
                        company providing these terms of service (Pretend). The
                      ...
                      <br />
                      <br />
                      Thank you for choosing Pretend (Bot). These Terms and
                      ...
                      <ol className="pl-3">
                        ...
                        <li className="text-white list-disc list-inside">
                          ...
                          <li>
                            ...
                            <li>
                              <a
                                href="https://docs.pretend.bot"
                                className="text-blue-400"
                                target="_blank"
                              >
                                https://docs.pretend.bot
                                </a>
                            </li>
                            <li>
                              <a
                ...
                <div>
                  <p className="text-sm tracking-wide text-loti-pink font-medium">
                    What information does Pretend (Bot) collect from you? as a
                    user:
                  </p>
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      Pretend (Bot) is a Discord Bot that requires information to
                      ...
                      <ol className="text-white list-disc list-inside pl-3">
                        ...
                        <li>
                          ...
                          being stored in Pretend completely
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          that data from being stored in Pretend completely
                        </li>
                        <li>
                          ...
                          Afk data is deleted from Pretend&apos;s storage completely
                        </li>
                      </ol>
                      <br />
                      These are only a few instances of the information we
                      gather from you as a user; as Pretend is a multifunctional
                ...
                <div>
                  <p className="text-sm tracking-wide text-loti-pink font-medium">
                    What information does Pretend (Bot) collect from a guild?
                  </p>
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      Pretend (Bot) also requires information from the specific
                      ...
                      <ol className="text-white list-disc list-inside pl-3">
                        ...
                        <li>
                          ...
                          enabled, or deleted from Pretend&apos;s storage completely
                        ...
                        <li>
                          ...
                          and can use Pretend (bot) services.
                        </li>
                        <li>
                          ...
                          <ol className="text-white list-disc list-inside pl-6">
                            ...
                            <li>
                              ...
                              automatically deleted from Pretend&apos;s storage (48
                      ...
                      <br />
                      These are only a few instances of the information we
                      gather from you as a guild; as Pretend is a multifunctional
                ...
                <div>
                  <p className="text-sm tracking-wide text-loti-pink font-medium">
                    What other information does Pretend (Bot) collect?
                  </p>
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      Pretend (Bot) collects various types of data, which may be
                      ...
                      <ul className="text-white list-disc list-inside pl-3">
                        <li>
                          <b>Blacklist from Pretend:</b> if blacklisted from Pretend
                          by bot admins, Pretend stores the user id of the
                          blacklisted user as well as the reason provided by the
                          bot admins
                        </li>
                        <li>
                          <b>Paid sheet:</b> Pretend has a sheet that includes the
                          paid members ids to keep track of payments
                        </li>
                        <li>
                          <b>Payment email:</b> Pretend gets the email used when
                          paying for <b>Pretend Paid</b> to send updates to
                          services as well as invoices
                        </li>
                        <li>
                          <b>Email address:</b> Pretend gets the email address
                          used when paying for <b>Pretend Paid</b> to send updates
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      ...
                      <br />
                      <br />
                      Pretend (Bot) uses the collected data to finish processes
                      and run commands such as starboard which requires the
                      starboard data to function properly.
                      <br />
                      <ol className="text-white list-disc list-inside pl-3">
                        <li>
                          <b>Complete a bots task:</b> some commands in Pretend
                          rely on data that is stored, or set by Pretend&apos;s users
                          and consumers, such as:
                          <ol className="text-white list-disc list-inside pl-6">
                            <li>
                              <b>Starboard:</b> Pretend requires the starboard
                              data, such as channel id, emoji, and threshold for
                              the starboard command to properly work
                            </li>
                            <li>
                              <b>Autorole:</b> Pretend requires the autorole data,
                        ...
                        <li>
                          <b>Feedback and errors:</b> Pretend stores all the
                        ...
                        <li>
                          <b>Bot presence:</b> the presence of Pretend includes
                          the number of guilds Pretend is in
                        </li>
                      </ol>
                    </p>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      Pretend does not share the information collected or
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <p className="text-neutral-200 inline-block text-sm py-1">
                      ...
                      data from Pretend, you can contact us at:
                      <ol className="pl-3">
                        <li className="text-white list-disc list-inside">
                          <a
                            href="https://discord.gg/K5J7UQgJTN"
